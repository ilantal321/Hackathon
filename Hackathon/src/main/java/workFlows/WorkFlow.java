...
public class WorkFlow extends CommonOps {
    ...
    public static void addUserTOGrafana(){
        ...
        grafanaUIActions.sendKeys(loginPage.getText_newName(),ManageDDT.getData("NewName"));
        grafanaUIActions.sendKeys(loginPage.getText_newUserEmail(),ManageDDT.getData("NewEmail"));
        grafanaUIActions.sendKeys(loginPage.getText_newUserName(),ManageDDT.getData("NewUserName"));
        grafanaUIActions.sendKeys(loginPage.getText_newPassword(),ManageDDT.getData("NewPassword"));
